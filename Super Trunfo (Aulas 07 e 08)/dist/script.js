var cartas1 = {
  nome: "Katniss",
  imagem:
    "http://3.bp.blogspot.com/-_R4zA-3Xc9s/VGygBxsBy8I/AAAAAAAAuU4/EJMoD0-Xq-0/s1600/Hunger%2BGames%2B3%2BMockingjay%2Bpart%2B1%2Bjennifer%2Blawrence%2Bkatniss%2Bfire%2Bmovie%2Bstill.jpg",
...
var cartas3 = {
  nome: "Rue",
  imagem: "https://media.hollywood.com/images/638x425/1923514.jpg",
...
var cartas4 = {
  nome: "Effie",
  imagem:
    "https://i.pinimg.com/originals/7e/88/72/7e8872a3c5a7fa61b2606a44ead83111.jpg",
...
var cartas5 = {
  nome: "Haymich",
  imagem:
    "https://hips.hearstapps.com/digitalspyuk.cdnds.net/15/47/1447947319-movies-hunger-games-haymitc-2.jpg",
...
var cartas6 = {
  nome: "Alma Coin",
  imagem:
    "https://images6.fanpop.com/image/photos/37800000/-Alma-Coin-the-hunger-games-37848370-630-630.jpg",
...
var cartas7 = {
  nome: "Gale",
  imagem:
    "http://pm1.narvii.com/6462/265c85e95b6438c19755fe57b0209e583f9a317d_00.jpg",
...
var cartas10 = {
  nome: "Johanna Mason",
  imagem:
    "https://i.pinimg.com/736x/6a/4d/18/6a4d18b83e9f073e156a525d7f52b554--she-s-hunger-games-trilogy.jpg",
...
var cartas11 = {
  nome: "Finnick",
  imagem:
    "https://observatoriodocinema.uol.com.br/wp-content/uploads/2016/05/finnick-odair-jogos-vorazes.jpg",
...
var cartas13 = {
  ...
  imagem:
    "https://www.bitchmedia.org/sites/default/files/styles/facebook_ratio/public/open-graph/Donald%20Sutherland%20as%20President%20Coriolanus%20Snow%20in%20The%20Hunger%20Games%20social%20image.jpg?itok=REjC6Nr4",
...
function sortearCarta() {
  if (cartasJogador.length > 0 && cartasMaquina.length > 0) {
    ...
    divResultado.innerHTML =
      "Um dos jogadores não tem cartas suficientes para jogar.";
  }
}
...
function jogar() {
  ...
  if (atributoSelecionado === undefined || atributoSelecionado === null) {
    divResultado.innerHTML = "Você não selecionou um atributo.";
  } else {
    if (
      ...
      htmlResultado =
        "<p class'resultado-final'>VOCÊ VENCEU! A CARTA DO ADVERSÁRIO AGORA É SUA.</p>";
    } else if (
      cartaJogador.atributos[atributoSelecionado] <
      cartaMaquina.atributos[atributoSelecionado]
    ) {
      ...
      htmlResultado =
        "<p class'resultado-final'>PERDEU! AGORA A SUA CARTA PERTENCE AO ADVERSÁRIO.</p>";
    } else {
